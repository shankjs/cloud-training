...
function CartItems() {
  ...
  const purchaseOrder = () => {
    console.log("cartSummary.totalRedeemPoints:" + cartSummary.totalRedeemPoints)
    console.log("availableRedeemPoints:" + availableRedeemPoints)
    ...
    axios
      .post(API_URL + "history/", orderData)
      .then((response) => {
        /**
